...
fn superCp(c: u8) ?u21 {
    return switch (c) {
        ...
        '4' => 0x2074, '5' => 0x2075, '6' => 0x2076, '7' => 0x2077, '8' => 0x2078, '9' => 0x2079,
...
fn subCp(c: u8) ?u21 {
    return switch (c) {
        ...
        's' => 0x209B, 't' => 0x209C, 'i' => 0x1D62, 'j' => 0x2C7C, 'r' => 0x1D63,
        'u' => 0x1D64, 'v' => 0x1D65,
        else => null,
    };
}
...
const math_macros = [_]MathRepl{
    ...
    // greek lowercase
    .{ .name = "alpha", .rep = "\u{03B1}" }, .{ .name = "beta", .rep = "\u{03B2}" }, .{ .name = "gamma", .rep = "\u{03B3}" },
    .{ .name = "delta", .rep = "\u{03B4}" }, .{ .name = "epsilon", .rep = "\u{03B5}" }, .{ .name = "varepsilon", .rep = "\u{03B5}" },
    .{ .name = "zeta", .rep = "\u{03B6}" }, .{ .name = "eta", .rep = "\u{03B7}" }, .{ .name = "theta", .rep = "\u{03B8}" },
    .{ .name = "vartheta", .rep = "\u{03B8}" }, .{ .name = "iota", .rep = "\u{03B9}" }, .{ .name = "kappa", .rep = "\u{03BA}" },
    .{ .name = "lambda", .rep = "\u{03BB}" }, .{ .name = "mu", .rep = "\u{03BC}" }, .{ .name = "nu", .rep = "\u{03BD}" },
    .{ .name = "xi", .rep = "\u{03BE}" }, .{ .name = "omicron", .rep = "\u{03BF}" }, .{ .name = "pi", .rep = "\u{03C0}" },
    .{ .name = "rho", .rep = "\u{03C1}" }, .{ .name = "sigma", .rep = "\u{03C3}" }, .{ .name = "tau", .rep = "\u{03C4}" },
    .{ .name = "upsilon", .rep = "\u{03C5}" }, .{ .name = "phi", .rep = "\u{03C6}" }, .{ .name = "varphi", .rep = "\u{03C6}" },
    .{ .name = "chi", .rep = "\u{03C7}" }, .{ .name = "psi", .rep = "\u{03C8}" }, .{ .name = "omega", .rep = "\u{03C9}" },
    // greek uppercase (the ones that differ from Latin letters)
    .{ .name = "Gamma", .rep = "\u{0393}" }, .{ .name = "Delta", .rep = "\u{0394}" }, .{ .name = "Theta", .rep = "\u{0398}" },
    .{ .name = "Lambda", .rep = "\u{039B}" }, .{ .name = "Xi", .rep = "\u{039E}" }, .{ .name = "Pi", .rep = "\u{03A0}" },
    .{ .name = "Sigma", .rep = "\u{03A3}" }, .{ .name = "Phi", .rep = "\u{03A6}" }, .{ .name = "Psi", .rep = "\u{03A8}" },
    .{ .name = "Omega", .rep = "\u{03A9}" },
    // spacing / styling macros — drop (or thin space)
    .{ .name = "left", .rep = "" }, .{ .name = "right", .rep = "" }, .{ .name = "displaystyle", .rep = "" },
    .{ .name = "limits", .rep = "" }, .{ .name = "quad", .rep = "  " }, .{ .name = "qquad", .rep = "    " },
    .{ .name = "space", .rep = " " },
};
