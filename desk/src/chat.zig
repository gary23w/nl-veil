...
const SYSTEM_REST =
    ...
    "- browser_click {\"ref\":N}  /  browser_type {\"ref\":N,\"text\":\"...\",\"submit\":true}  /  browser_close {}  — click or type into a ref from browser_read (real trusted input, so sites accept it; submit presses Enter), or close the browser when done.\n" ++
...
const SYSTEM_REST_COMPACT =
    ...
    "{} — a real browser on this machine for pages a plain fetch can't handle. recall_hive " ++
